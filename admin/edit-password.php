      ...
      <!--TopNav-->
          ...
          <div class="container">
            <div class="col offset-l2 nav-wrapper">
              ...
              <a class="page-title">Edit Password</a>
            </div>
          </div>
      </nav>
      ...
      <ul id="slide-out" class="side-nav fixed">
              ...
              <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                  ...
                  <li><a href="barang.php">Barang Masuk</a></li>
                </ul>
              </div>
                    </li>
          ...
          <div class="col s12 m12 l12 card-panel z-depth"> <br>
            <table class="highlight">
              ...
              <table>
                <tr>
                  <th>
                    <input type="submit" name="update" value="Simpan" class="right waves-effect waves-light btn green darken-2" style="float: left;">
                  </th>
                  <th style="width: 1%;">
                    <a href="user.php"><input type="button" value="Kembali" class="right waves-effect waves-light btn grey darken-2"></a> 
                  </th>
                </tr>
              </table>
          </div>
