	        ...
	        <nav class="row top-nav brown darken-2">
	    		<div class="container">
	    			<div class="col offset-l2 nav-wrapper">
	    				...
	    				<a class="page-title">Input Barang</a>
	    			</div>
	    		</div>
			</nav>
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
									...
									<li class="active brown darken-4"><a>Barang</a></li>
								</ul>
							</div>
		                </li>
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
				              <th>ID Barang</th>
				              <th><input type="text" name="id_barang" requibrown></th>
				            </tr>
			              	<tr>
			                	<th>Nama Barang</th>
			                	<th><input type="text" name="nama_barang" requibrown></th>
			              	</tr>
			              	<tr>
			                	<th>Jenis Barang</th>
			                	<th><input type="text" name="jenis_barang" requibrown></th>
			              	</tr>
			              	<tr>
			                	<th>Jumlah Barang</th>
			                	<th><input type="text" name="jumlah_barang" requibrown></th>
			              	</tr>
			              	<tr>
			                	<th>Tanggal Update</th>
			                	<th><input type="date" name="waktu" requibrown></th>
			              	</tr>
						</table>
						<table>
				            <tr>
				            	...
				            	<th style="width: 1%;">
				            		<a href="barang.php"><input type="button" value="Kembali" class="right waves-effect waves-light btn brown darken-2"></a> 
				            	</th>
				            </tr>
				        </table>
					</div>
