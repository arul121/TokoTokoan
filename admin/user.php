					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['nama']; 
				                echo "<tr>";
			                    echo "<td hidden>".sanitize_key($user_data['id'])."</td>";
				                ...
				                echo "<td> <a href='edit-user.php?id=".sanitize_key($user_data[id])."' style='text-decoration: none;'><i class='material-icons' title='Edit ".sanitize_key($test)."'>mode_edit</i></a> | <a data-id='1' class='hapus' href='delete.php?id=".sanitize_key($user_data[id])."' style='text-decoration: none;'><i class='material-icons' title='Hapus ".sanitize_key($test)."'>delete</i></a> | <a href='edit-password.php?id=".sanitize_key($user_data[id])."' style='text-decoration: none;'><i class='material-icons' title='Ganti Kata Sandi ".sanitize_key($test)."'>lock</i></a> </td></tr>";
				            }
